...
from model import QuestionMatchingAttentionDomain, QuestionMatchingAttentionDomainWithBiLSTM
...
if __name__ == "__main__":
    ...
    model = QuestionMatchingAttentionDomainWithBiLSTM(pretrained_model, model_config)
